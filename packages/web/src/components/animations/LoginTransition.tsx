...
const LoginTransition: React.FC<Props> = ({ animationState, startAnimation, redirectUrl, history }) => {
            ...
            >
                <div className="animation-box">
                    <Flex
                        ...
                        position="absolute"
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" width="316" height="138" viewBox="0 0 316 138" id="logo">
                            <defs>
